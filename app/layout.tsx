  ...
  return (
    <html lang="en">
      <body className="antialiased bg-black ">
        ...
        <div
          id="modal"
          className="flex hidden flex-col justify-center overflow-hidden fixed right-0 left-0 bottom-0 top-0 m-auto bg-black sm:bg-[#00000096] rounded-[8px] h-screen sm:h-fit w-[90%] z-[999]  p-[20px] border border-[#b2b7ba]"
        >
